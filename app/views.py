...
def friend_profile(username):
    ...
    return render_template('profile.html', npost = NewPost(), filename='', posts=posts, profile_picture=profile_picture, uploadForm = ProPicUpload(), friend_post = NewPost(), username=username)
